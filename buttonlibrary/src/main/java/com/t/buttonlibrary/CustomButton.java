...
GradientDrawable drawable=new GradientDrawable();
  ...
  /*  private Padding mPadding;
    ...
    private int cornerRadius=(int)  getResources().getDimension(R.dimen.bt_corner_radius_2);
    private int blue=(int)  getResources().getColor(R.color.colorPrimary);
    private int blueDark=(int)  getResources().getColor(R.color.colorAccent);
    private void initView() {
